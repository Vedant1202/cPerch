...
notarization (and a Homebrew cask), which need a paid Apple Developer account. See the
[handover guides](docs/handover-v0.6.md) for the current state and what's next.
